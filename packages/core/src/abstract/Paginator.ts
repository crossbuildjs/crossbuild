...
export abstract class Paginator {
	...
	abstract send(interaction: ReceivedInteraction, page: number): Promise<void>
	//  {
	...
	abstract handlePage(data: PageTrigger): Promise<void>
	...
	abstract makeMessage(page: number): GeneratedMessageObject
